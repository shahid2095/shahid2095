      ...
      <li class="active"><a href="../index.php">Home</a></li>
       ...
       <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a href="ordersS.php">Search Order's</a></li>
          <li><a href="ordersS.php">All Order's</a></li>
          <li><a href="ordersN.php">New Order's</a></li>
          <li><a href="ordersP.php">Pending</a></li>
          <li><a href="ordersC.php">Cenceled</a></li> 
          <li><a href="ordersR.php">Return Requests</a></li> 
        </ul>
