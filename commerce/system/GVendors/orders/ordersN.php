...
<form action="" method="get">
 ...
 <option value="5">5</option>
  ...
  <input type="submit" name="submit" value="update" class="yellow-grade">
</form>
</div>
<div class="col-md-10">
...
<input type="hidden" name="status" value="search" >
  <button type="submit" class="yellow-grade" style="padding: 8px;">
...
$product = "SELECT * FROM `orders` WHERE `status` = 'new'  LIMIT ".$limit." OFFSET ".$offset."";
