...
<h2>Add New Product </h2>
  <ul class="nav nav-tabs">
    ...
    <li><a data-toggle="tab" href="#list">Add Details</a></li>
    <li><a data-toggle="tab" href="#specification">Add Specification</a></li>
...
<input type='file'  name='fileToUpload'><br>
    ...
    <div id="list" class="tab-pane fade">
      <h3>Add list of product details & Specifications</h3>
