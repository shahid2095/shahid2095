...
<ul class="nav nav-tabs">
  <li class="active"><a data-toggle="tab" href="#home">Add L-One Category Item</a></li>
  <li><a data-toggle="tab" href="#menu1">Remove L-One Category Item</a></li>
</ul>
...
<div class="tab-content">
  <div id="home" class="tab-pane fade in active">
   <div class="row">
   <div class="col-md-8">
<form method="get" action="inc/insert_into_catagory_l1.php" style="margin-top: 2%;">
