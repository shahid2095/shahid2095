...
<div class="col-xs-2 col-sm-2 col-md-2">
    ...
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form" action="system/general_pages/vregister.php" method="post">
			...
			<div class="form-group">
				<input type="text" name="display_name" id="display_name" class="form-control input-lg" placeholder="Company Name" tabindex="3">
			</div>
			<div class="form-group">
